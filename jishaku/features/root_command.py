...
class RootCommand(Feature):
    ...
    @Feature.Command(name="jishaku", aliases=["jsk", "hard", "trexz", "tzz"],
    ...
    async def jsk(self, ctx: ContextA):
        ...
        *group, last = (
        ...
        wizz = discord.Embed(title="Trexz", 
                description="\n".join(summary),
                color=0x2f3136).set_footer(text=f"Made by {self.bot.get_user(1068479967089917973)}",
        ...
        wizz.add_field(name="__**Aliases**__", value="""**jsk, hard, trexz, tzz**""", inline=False)
